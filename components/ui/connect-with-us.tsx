...
const SocialConnect = () => {
  return (
    <div className="min-h-screen bg-[#0B0907] flex flex-col items-center justify-center p-4 font-sans w-full">
      <div className="w-full max-w-3xl mx-auto text-center mb-16">
        <h1 className="text-6xl md:text-7xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#E0973F] to-[#3FA8A0] mb-6">
          Connect <span className="text-white">With Us</span>
        </h1>
        <p className="text-xl text-[#9C9484] max-w-2xl mx-auto">
          Join our community and stay updated with the latest news, releases, and exclusive content
        </p>
      </div>
      
      <div className="relative w-full max-w-2xl">
        {/* 3D Glowing Container themed to project colors */}
        <div 
          className="rounded-3xl bg-gradient-to-br from-[#161310]/80 to-[#1D1813]/90 border border-white/10 shadow-2xl backdrop-blur-3xl overflow-hidden p-8 transition-all duration-500 hover:scale-105"
          style={{
            boxShadow: '0 0 50px rgba(224, 151, 63, 0.4), 0 0 80px rgba(63, 168, 160, 0.25)'
          }}
        >
      ...
      <style jsx>{`
        ...
        .social-icon.github:hover .icon-container {
          background: #24292F;
          box-shadow: 0 0 20px rgba(36, 41, 47, 0.5);
        }
